      ...
      <div className="title-accordian">
        ...
        <div className="title-text">
          <p className="send-question">
            بیشترین تعداد سوالاتی که تا به امروز پرسیده شده . سوال شما جزو
            سوالات نیست ؟
          </p>
          <Link className="send-question send-part" to="./Contact">
            ارسال سوال
          </Link>
        </div>
      </div>
          ...
          return (
            <div className="items" key={id}>
              <header className="header-accordian">
                <h6 className="" onClick={() => toggleAccordian(id)}>
                  {question}
                </h6>
                <button
                  className="open-accordian-btn"
